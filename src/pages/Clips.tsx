...
function ClipCard({ clip, episodes, onClick }: { clip: Clip; episodes: Episode[]; onClick: () => void }) {
...
function ClipModal({ clip, episodes, onClose }: { clip: Clip | null; episodes: Episode[]; onClose: () => void }) {
